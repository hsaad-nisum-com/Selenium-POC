...
public class dashboardPage extends AbstractComponents {
    ...
    public void dashboardPageValidationMethod()  {
       String dashboardvalidationText = dashboardTitleTxt.getText();
        Assert.assertEquals(dashboardvalidationText,"Dashboard");
    }
}
