...
public class directoryPage extends AbstractComponents {
    ...
    public void directoryPageValidationMethod()  {
        String directoryValidationText = directoryTitleTxt.getText();
        Assert.assertEquals(directoryValidationText,"Directory");
    }
}
