...
public class buzzPage extends AbstractComponents {
    WebDriver driver;
    ...
    public void buzzValidationMethod() {
        String buzzText = buzzTitleTxt.getText();
        Assert.assertEquals(buzzText,"Buzz");
        }
    }
